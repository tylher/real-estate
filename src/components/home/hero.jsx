...
//
// Rotating hero: 4 slides, each a paired sky/building image. The hero has a
// FIXED height (h-[92vh]) — the sky fills that space edge-to-edge, and the
// building sits on top of it sized by its own real aspect ratio, not by a
// guessed height percentage. That's what keeps the two images reading as
// one continuous photo instead of two mismatched crops.
...
export default function HeroSection() {
  ...
  return (
    <section
      className="relative min-h-[640px] bg-ink"
    ...
    >
      ...
      */}
      <div className="sticky inset-x-0 top-0 z-30 h-screen w-screen">
        ...
        <div className="absolute bottom-28 left-6 z-30 max-w-md sm:bottom-32 sm:left-10 md:max-w-lg">
          <AnimatePresence mode="wait">
